...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "h-11 flex items-center justify-center rounded-full font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2";
